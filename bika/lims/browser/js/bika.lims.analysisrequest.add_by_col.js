...
(function() {
  window.AnalysisRequestAddByCol = function() {
    ...
    recalc_prices = function(arnum) {
      var ardiscount_amount, arprofiles_price, arprofiles_vat_amount, arservice_vat_amount, arservices_price, base_price, cb, checked, i, member_discount, profiles, service_price, service_vat_amount, services_from_priced_profile, subtotal, total, vat_amount;
