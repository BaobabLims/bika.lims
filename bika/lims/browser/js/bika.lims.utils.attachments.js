...
/**
 * Controller class for attachments
 */
...
(function() {
  ...
  window.AttachmentsUtils = (function() {
    ...
    AttachmentsUtils.prototype.load = function() {
      console.debug("AttachmentUtils::load");
